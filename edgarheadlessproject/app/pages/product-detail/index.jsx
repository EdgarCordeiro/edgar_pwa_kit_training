...
const ProductDetail = ({category, product, isLoading}) => {
    ...
    const handleAddToWishlist = async (quantity, isInWishlist) => {
        ...
        >
            ...
            <Stack spacing={16}>
                <ProductView
                    ...
                    addToWishlist={(_, quantity, isProductInWishlist) => handleAddToWishlist(quantity, isProductInWishlist)}
                    isProductLoading={isLoading}
                    isCustomerProductListLoading={!wishlist.isInitialized}
                    isProductInWishlist={!!wishlist.findItemByProductId(product ? product.id : "")}
                />
