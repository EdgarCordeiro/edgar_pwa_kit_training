...
const ProductTile = (props) => {
    ...
    const handleOpenQuickView = async () => {
        ...
        const productApi = await api.shopperProducts.getProduct({
            parameters: {
                id: productId,
                allImages: true
            }
        ...
        console.log(JSON.stringify(productApi))

        setSelectedItem(productApi)
        onOpen()
    }
    ...
    return (
        <Box>
            ...
            <Box d="flex" pt={2} justifyContent="center" alignItems="center">
                <Button
                    w="100%"
                    onClick={() => {
                        handleOpenQuickView()
